...
set init_verilog [list "inputs/aer_improved_hierarchical_pnr.v"]
set init_top_cell aer_improved_hierarchical
set init_pwr_net VDD
set init_gnd_net VSS
set init_mmmc_file "scripts/p2_pnr.view"

file mkdir reports outputs db
init_design
setDesignMode -process 180

# Core-only block floorplan. No pad ring is inferred or claimed.
...
# Small core ring and standard-cell rail hookup. This is a core-only power
# network, not a pad ring or package design.
...
defOut -routing outputs/aer_improved_hierarchical_postroute.def
saveNetlist outputs/aer_improved_hierarchical_postroute.v
write_sdf outputs/aer_improved_hierarchical_postroute.sdf
rcOut -spef outputs/aer_improved_hierarchical_postroute.spef
saveDesign db/aer_improved_hierarchical_postroute.enc -rc

puts "P2_INNOVUS_180NM_DONE"
exit
