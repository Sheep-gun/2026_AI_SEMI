...
set init_verilog [list "inputs/aer_improved_homeostatic_pnr.v"]
set init_top_cell aer_improved_homeostatic
...
saveDesign db/aer_improved_homeostatic_postroute.enc -rc
puts "P4_INNOVUS_180NM_DONE"
exit
