...
set saif_file [file join $project_root reports p9grr_contract_vcd p9grr_mapped_activity.saif]
set report_file [file join $project_root reports p9grr_pnr postroute_power_saif.rpt]

foreach required_file [list $design_db $saif_file] {
    if {![file exists $required_file]} {
        error "P9-GRR post-route SAIF input missing: $required_file"
    }
}
...
puts "P9GRR_POSTROUTE_SAIF_POWER_DONE"
exit
