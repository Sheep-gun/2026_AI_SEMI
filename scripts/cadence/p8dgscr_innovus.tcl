...
set view_file [file join $project_root scripts cadence p8dgscr_pnr.view]
set report_dir [file join $project_root reports p8dgscr_pnr]
set output_dir [file join $project_root outputs p8dgscr_pnr]
set db_dir [file join $project_root db]

foreach required_file [list $netlist_file $view_file] {
    if {![file exists $required_file]} {
        error "P8-DG-SCR Innovus input not found: $required_file"
    }
}
...
set init_top_cell aer_pending_direct_gray_sync_core_reset
...
# The SDC additionally limits pair data delay to 0.5 ns.
...
puts "P8DGSCR_CDC_PHYSICAL_GROUPS_CREATED=17"
...
defOut -routing [file join $output_dir aer_pending_direct_gray_sync_core_reset_postroute.def]
saveNetlist [file join $output_dir aer_pending_direct_gray_sync_core_reset_postroute.v]
write_sdf [file join $output_dir aer_pending_direct_gray_sync_core_reset_postroute.sdf]
rcOut -spef [file join $output_dir aer_pending_direct_gray_sync_core_reset_postroute.spef]
saveDesign [file join $db_dir aer_pending_direct_gray_sync_core_reset_postroute.enc] -rc
puts "P8DGSCR_INNOVUS_180NM_DONE"
exit
