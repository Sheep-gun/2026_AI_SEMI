...
set init_verilog [list "inputs/aer_improved_depth1_pnr.v"]
set init_top_cell aer_improved_depth1
set init_pwr_net VDD
set init_gnd_net VSS
set init_mmmc_file "scripts/p3_pnr.view"
...
defOut -routing outputs/aer_improved_depth1_postroute.def
saveNetlist outputs/aer_improved_depth1_postroute.v
write_sdf outputs/aer_improved_depth1_postroute.sdf
rcOut -spef outputs/aer_improved_depth1_postroute.spef
saveDesign db/aer_improved_depth1_postroute.enc -rc
puts "P3_INNOVUS_180NM_DONE"
exit
