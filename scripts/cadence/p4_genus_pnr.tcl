...
read_hdl -sv rtl/aer_improved_homeostatic.sv
elaborate aer_improved_homeostatic
check_design -unresolved
set scan_cells [get_db lib_cells *SDFF*]
if {[llength $scan_cells] > 0} { set_db $scan_cells .avoid true }
puts "P4_SCAN_CELLS_AVOIDED=[llength $scan_cells]"
...
write_hdl > inputs/aer_improved_homeostatic_pnr.v
puts "P4_GENUS_PNR_NETLIST_DONE"
exit
