...
file mkdir reports/p7ge inputs
report_area > reports/p7ge/genus_area.rpt
report_gates > reports/p7ge/genus_gates.rpt
report_timing -max_paths 50 > reports/p7ge/genus_timing.rpt
report_power > reports/p7ge/genus_power.rpt
report_qor > reports/p7ge/genus_qor.rpt
write_hdl > inputs/aer_pending_gray_epoch_pnr.v
puts "P7GE_GENUS_DONE"
exit
