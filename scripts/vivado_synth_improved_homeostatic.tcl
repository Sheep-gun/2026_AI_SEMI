set report_dir reports/improved_homeostatic/vivado_sanity
file mkdir $report_dir
set part xc7a35tcpg236-1
read_verilog -sv rtl/improved/aer_improved_homeostatic.sv
synth_design -top aer_improved_homeostatic -part $part -flatten_hierarchy rebuilt
...
write_verilog -force -mode funcsim [file join $report_dir aer_improved_homeostatic_post_synth.v]
write_sdf -force [file join $report_dir aer_improved_homeostatic_post_synth.sdf]
set summary [open [file join $report_dir summary.txt] w]
puts $summary "purpose=P4 homeostatic cut-through FPGA synthesis sanity"
