set report_dir reports/p8_candidates/vivado_direct_gray_shared_tree
file mkdir $report_dir
set part xc7a35tcpg236-1

read_verilog -sv rtl/improved/aer_pending_direct_gray_shared_tree.sv
synth_design -top aer_pending_direct_gray_shared_tree -part $part -flatten_hierarchy rebuilt
...
puts $summary "reset_mode=robust_core_sparse_data_reset"
...
puts $summary "P8_DGT_SYNTH_PASS"
close $summary

write_verilog -force -mode funcsim \
    [file join $report_dir aer_pending_direct_gray_shared_tree_post_synth.v]
puts "P8_DGT_SYNTH_PASS"
