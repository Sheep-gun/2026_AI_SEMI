set report_dir reports/p8_candidates/vivado_direct_gray_split_reset
file mkdir $report_dir
set part xc7a35tcpg236-1

read_verilog -sv rtl/improved/aer_pending_direct_gray_split_reset.sv
synth_design -top aer_pending_direct_gray_split_reset -part $part -flatten_hierarchy rebuilt
...
puts $summary "reset_mode=async_observable_sync_internal_no_isolation"
puts $summary "epoch_mode=direct_reflected_gray"
puts $summary "arbitration_validity=shared_balanced_or_tree"
puts $summary "request_acceptance=vector_factored"
puts $summary "P8_DGPR_SYNTH_PASS"
close $summary

write_verilog -force -mode funcsim \
    [file join $report_dir aer_pending_direct_gray_split_reset_post_synth.v]
puts "P8_DGPR_SYNTH_PASS"
