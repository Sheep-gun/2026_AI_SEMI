...
set variants {
    {aer_pending_xor2_sparse_reset rtl/improved/aer_pending_xor2_sparse_reset.sv}
    {aer_pending_gray_ring_sparse_reset rtl/improved/aer_pending_gray_ring_sparse_reset.sv}
}
foreach item $variants {
    lassign $item top rtl
    set report_dir [file join reports p8_pareto vivado $top]
    ...
    puts $summary "reset_mode=resetless_cdc_robust_transport_core"
    close $summary
    write_verilog -force -mode funcsim [file join $report_dir ${top}_post_synth.v]
    close_design
}
puts "P8_PARETO_SYNTH_PASS"
