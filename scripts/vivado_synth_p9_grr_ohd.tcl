set report_dir reports/p9_state_compression/vivado_grr_ohd
file mkdir $report_dir
set part xc7a35tcpg236-1
read_verilog -sv rtl/experiments/aer_pending_gray_rank_reuse_sync_core_reset.sv
read_verilog -sv rtl/experiments/aer_pending_gray_rank_reuse_onehot_decode.sv
synth_design -top aer_pending_gray_rank_reuse_onehot_decode -part $part -flatten_hierarchy rebuilt
...
puts $summary "consume=onehot_decode_vector_mask"
puts $summary "P9_GRR_OHD_SYNTH_PASS"
close $summary
write_verilog -force -mode funcsim [file join $report_dir aer_pending_gray_rank_reuse_onehot_decode_post_synth.v]
puts "P9_GRR_OHD_SYNTH_PASS"
