set report_dir reports/p9_state_compression/vivado_grr_oi
file mkdir $report_dir
set part xc7a35tcpg236-1
read_verilog -sv rtl/experiments/aer_pending_gray_rank_reuse_sync_core_reset.sv
read_verilog -sv rtl/experiments/aer_pending_gray_rank_reuse_operand_isolated.sv
synth_design -top aer_pending_gray_rank_reuse_operand_isolated -part $part -flatten_hierarchy rebuilt
...
puts $summary "power_optimization=selector_operand_isolation_on_stall_and_reset"
puts $summary "P9_GRR_OI_SYNTH_PASS"
close $summary
write_verilog -force -mode funcsim [file join $report_dir aer_pending_gray_rank_reuse_operand_isolated_post_synth.v]
puts "P9_GRR_OI_SYNTH_PASS"
