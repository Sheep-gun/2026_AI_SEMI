set report_dir reports/pending_gray_epoch/vivado_robust
...
puts $summary "P7_GE_ROBUST_SYNTH_PASS"
close $summary

write_verilog -force -mode funcsim \
    [file join $report_dir aer_pending_gray_epoch_robust_post_synth.v]
puts "P7_GE_ROBUST_SYNTH_PASS"
