set report_dir reports/p8_candidates/vivado_direct_gray_sync_core_reset
file mkdir $report_dir
set part xc7a35tcpg236-1

read_verilog -sv rtl/improved/aer_pending_direct_gray_sync_core_reset.sv
synth_design -top aer_pending_direct_gray_sync_core_reset -part $part -flatten_hierarchy rebuilt
...
puts $summary "P8_DGSCR_SYNTH_PASS"
close $summary

write_verilog -force -mode funcsim \
    [file join $report_dir aer_pending_direct_gray_sync_core_reset_post_synth.v]
puts "P8_DGSCR_SYNTH_PASS"
