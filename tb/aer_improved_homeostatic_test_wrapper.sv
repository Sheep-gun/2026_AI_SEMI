...
`ifdef P4_GATE_NETLIST
    aer_improved_homeostatic implementation (
`else
    aer_improved_homeostatic #(.NUM_SOURCES(NUM_SOURCES), .ADDR_W(ADDR_W)) implementation (
`endif
