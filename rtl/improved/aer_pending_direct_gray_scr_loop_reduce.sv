...
// P9-LR experiment: the original source-loop acceptance and independent
// reduction expressions combined with the P8-DG-SCR reset/output shell.
// This lets ASIC synthesis choose its own factoring instead of prescribing a
// shared validity tree.  Observable behavior is cycle-identical to P8-DG-SCR.
